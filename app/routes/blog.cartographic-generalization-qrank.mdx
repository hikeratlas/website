...
Hmmmm. On the one hand, Forks now appears. This is where the popular movie series _Twilight_ was filmed, so that seems reasonable.

On the other hand, Index, Aberdeen, Washington and Cheney now also appear. Unfortunately, this seems to be a downside of QRank: it confuses things with similar names. The Wikipedia page for [Index](https://en.wikipedia.org/wiki/Index) is a disambiguation page, with one of the options being the page for Index, WA. I suspect QRank is summing up the popularity of all of the entries on the disambiguation page, giving Index, WA an unfair advantage over other cities.
